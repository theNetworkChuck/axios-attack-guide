...
**Mac/Linux:**
```bash
curl -sL https://github.com/theNetworkChuck/axios-attack-guide/raw/refs/heads/main/check.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://github.com/theNetworkChuck/axios-attack-guide/raw/refs/heads/main/check.ps1 | iex
```
